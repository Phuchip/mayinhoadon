...
(function () {
	...
	CKEDITOR.editorConfig = function (config) {
		...
		***/
		...
		// File browser
		config.filebrowserBrowseUrl = "http://localhost:8182/ckeditor/ckfinder/ckfinder.php",
			config.filebrowserUploadUrl = "http://localhost:8182/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files",
			config.filebrowserImageUploadUrl = "http://localhost:8182/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images",
			config.filebrowserFlashUploadUrl = "http://localhost:8182/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash",
