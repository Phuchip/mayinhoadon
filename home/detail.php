                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12 col-12 intro-item">
                        ...
                        <div class="intro-item-body">
                            <ul id="multiple-items">
                                <li><img class="img-fluid item-img images-slick show-gallery" data-lazy="/images/item/<?= $data['image'] ?>" alt="Ảnh đại diện"></li>
                                <?php foreach ($list_img as $key => $value) : ?>
                                    <li><img class="img-fluid item-img images-slick show-gallery" data-lazy="/images/item/<?= $value ?>" alt="INRT029"></li>
                                <?php endforeach ?>
                            </ul>
