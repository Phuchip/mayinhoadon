<div class="info-product-content-mobile">
    <div class="parent-btn-ipcm">
        <button class="btn-ipcm"><p>Thông số kĩ thuật</p><i class="ic-angle-right"></i></button>
        <div class="info-product-body slideToggle">
            ...
            <div class="product-intro-body">
                <table>
                    ...
                    <tr>
                        ...
                        foreach($tinh_nang as $value){echo "<p>$value</p>";} ?></td>
                    </tr>
                    <tr>
                        <td>Kết nối</td>
                        <td><?= $data['ket_noi'] ?></td>
    ...
    <div class="parent-btn-ipcm">
        <button class="btn-ipcm"><p>Đánh giá sản phẩm</p><i class="ic-angle-right"></i></button>
        <div class="info-product-intro slideToggle">
            <div class="product-intro-title">
    ...
    <div class="parent-btn-ipcm">
        <button class="btn-ipcm"><p>Ý kiến khách hàng</p><i class="ic-angle-right"></i></button>
        <div class="product-comment slideToggle">
            <div class="pc-title">
            ...
            <div class="tab-rate-cmt">
                ...
                <div class="tab-cmt-are">
                    <div class="comment-are">
                        <form method="POST">
                            <textarea name="comment" class="input-txt input-comment"> </textarea>
                            <div class="group-input">
                                <div class="group-btn-left">
                                    <button class="send_img" type="button"><i class="ic-camera"></i>Gửi ảnh</button>
